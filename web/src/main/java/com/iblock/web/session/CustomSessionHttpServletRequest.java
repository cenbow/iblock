...
public class CustomSessionHttpServletRequest<SessionT extends HttpSession> extends HttpServletRequestWrapper {
    ...
    public void close() {
        ...
        try {
            sessionFactory.releaseSession(currentSession, wrapped);
        } catch (Exception ex) {
